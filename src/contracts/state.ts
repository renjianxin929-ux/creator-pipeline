...
export const transitionTable: Readonly<Record<ProjectStateValue, readonly ProjectStateValue[]>> = {
  ...
  HUMAN_APPROVED: ["EXPORT_READY", "PREVIEW_READY", "WAITING_USER_ACTION", "FAILED"],
  EXPORT_READY: ["PREVIEW_READY", "PUBLISH_READY", "WAITING_USER_ACTION", "FAILED"],
  PUBLISH_READY: ["WAITING_USER_ACTION"],
  PUBLISHED: [],
